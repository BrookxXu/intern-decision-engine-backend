...
class DecisionEngineTest {
    ...
    void testNoValidLoanFound() {
        assertThrows(NoValidLoanException.class,
                () -> decisionEngine.calculateApprovedLoan(debtorPersonalCode, Long.valueOf(DecisionEngineConstants.MAXIMUM_LOAN_AMOUNT), DecisionEngineConstants.MAXIMUM_LOAN_PERIOD));
    }
